...
export default function CapitalAdvisorSection() {
  ...
  const barWidth = useTransform(progress, BAR_RANGE, ['82%', '100%']);
      ...
      <div className="sticky top-0 flex h-screen flex-col overflow-hidden">
        ...
        <div className="relative z-10 px-6 pb-8 sm:px-10 sm:pb-10 lg:px-16">
          <motion.form
            ...
            className="mx-auto flex max-w-3xl items-center gap-3 rounded-full border px-5 backdrop-blur-md sm:px-7"
          >
